...
/**
 * GET /quiz/quizId Ma zwrócić pierwsze pytanie dla danego quizu
 *
 * <p>POST /quiz/quizId Ma przetworzyć odpowiedź dla danego quizy oraz wyświetlić kolejne pytanie
 */
@Controller
@RequestMapping("/quiz")
...
public class QuizController {
  ...
  public String showQuestion(@PathVariable("quizReference") String quizReference, Model model)
    ...
    // IllegalArgumentException("Question not exists"));
  ...
  public String handleAnswer(AnswerDto answerDto, Model model) throws QuizNotFoundException {
    ...
    //        var question = questionRepository.findById(exerciseId).orElseThrow(() -> new
    // IllegalArgumentException("Question not exists"));
